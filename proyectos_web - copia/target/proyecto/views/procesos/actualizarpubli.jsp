        ...
        <center>
            <div class="container">
                ...
                <form action="publicacion" method="post">
                    ...
                    <input type="number" class="idf" id="idf" name="idf" required><br>
                    ...
                    <input type="text" class="linkf" id="linkf" name="linkf" required><br>


                    <button type="submit" class="registro" name="accionFormface" value="actualizarf">Actualizar</button>
                </form>
